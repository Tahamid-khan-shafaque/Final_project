...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
     ...
     $select_query="Select * from `categories` where brand_name='$brand_name'";
     ...
     if($number>0){
      ...
      echo "<script>(' not inserted successfully')</script>";
        ...
        header('location:index.php?insert_brands');
...
<h1 class="text-center text-white" >Insert Countries</h1>
    <form action="../admin_area/insert_brands.php" method="post">
    <div class="form-group text-white">
        <label for="name">Name</label>
        <input type="text" name="brand_name" class="form-control">
    </div>
    <button type="submit" class="btn btn-success" >Insert Countires</button>
    </form>
</div>
