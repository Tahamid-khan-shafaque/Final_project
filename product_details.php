...
<div class="bg-light">
    ...
    <p class="text-center">The world is a book and those who do not travel read only one page</p>
</div>
...
<div class="row">
   ...
   <!--   <div class="col-md-8">
        ...
        <div class="row">
         ...
         <div class="col-md-6">
         <img src='./img/alo2.jpg' class='card-img-top' alt='...'>
         </div>
         <div class="col-md-6">
         <img src='./img/alo3.jpg' class='card-img-top' alt='...'>
            </div>
        </div>
      </div>  -->
      <!-- fatching products -->
